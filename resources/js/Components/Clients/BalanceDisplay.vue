        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg p-6 border border-gray-200 dark:border-gray-700">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-blue-600 dark:text-blue-400">R$ {{ formatCurrency(balance) }}</p>
                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-2">Saldo pré-pago disponível</p>
                </div>

<template>
    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24">
        ...
        <g fill="none">
            ...
            />
            <path fill="#fff" d="M6.74 1.48H3.506a.96.96 0 0 0-.855.529L1.002 5.305h4.782z" />
            <path fill="#ffbfc5" d="M12 5.305V1.48H6.74l-.956 3.825z" />
            <path fill="#fff" d="M18.216 5.305L17.26 1.48H12v3.825z" />
            <path fill="#ffbfc5" d="m22.998 5.305l-1.65-3.296a.96.96 0 0 0-.854-.53h-3.235l.957 3.826z" />
            <path
                fill="#ff808c"

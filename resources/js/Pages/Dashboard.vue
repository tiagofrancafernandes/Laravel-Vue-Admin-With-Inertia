  ...
  <AppLayout>
    <div class="space-y-6">
      ...
      <div>
        ...
        <p class="text-gray-600 dark:text-gray-400 mt-1">Bem-vindo de volta, {{ $page.props.auth.user.name }}!</p>
      </div>
      ...
      <Card title="Clientes Principais">
        <Table
          ...
          :rows="topClients"
        >
          <template #column-total_spent="{ row }">
            R$ {{ formatCurrency(row.total_spent) }}
          </template>

        ...
        <div v-if="sale.items && sale.items.length > 0" class="overflow-x-auto">
          <table class="w-full">
            ...
            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
              <tr v-for="(item, index) in sale.items" :key="index" class="hover:bg-gray-50 dark:hover:bg-gray-700">
        ...
        <div v-if="sale.payments && sale.payments.length > 0" class="space-y-3">
          ...
          >
            ...
            <div class="text-right">
              ...
              <p v-if="payment.change_amount && parseFloat(payment.change_amount) > 0" class="text-sm text-gray-600 dark:text-gray-400">
